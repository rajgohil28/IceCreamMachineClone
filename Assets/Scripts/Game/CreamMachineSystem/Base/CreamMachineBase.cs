...
namespace Game.CreamMachineSystem.Base
{
    public class CreamMachineBase : MonoBehaviour
    {
        ...
        private Transform _pistachioStick;
        #region Controllers
        ...
        private void OnInstaller(PlayerInputController playerInputController)
        {
            ...
            _pistachioStick = transform.Find("PistchioStick");
        }
        ...
        private void InputEventsSubscriptions()
        {
            ...
            //Pistachio Stick Movement
            _playerInputController.SubscribeHoldingEvent(CreamType.PISTACHIO, () =>
                _pistachioStick.DORotate(Vector3.forward * 45f, 1f)
            );
            _playerInputController.SubscribeReleasingEvent(CreamType.PISTACHIO, () =>
                _pistachioStick.DORotate(Vector3.zero, 1f)
            );
        }
    }
}
